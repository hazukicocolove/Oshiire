...
#ifndef OSHIIRE_SWIFT_H
#define OSHIIRE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Oshiire",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Oshiire11AppDelegate")
...
SWIFT_CLASS("_TtC7Oshiire18CollectionViewCell")
@interface CollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified shashin;
...
SWIFT_CLASS("_TtC7Oshiire13SceneDelegate")
...
SWIFT_CLASS("_TtC7Oshiire17SubViewController")
...
SWIFT_CLASS("_TtC7Oshiire3Use")
@interface Use : RealmSwiftObject
@property (nonatomic, strong) NSData * _Null_unspecified realmUse;
@property (nonatomic, copy) NSString * _Nonnull date;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7Oshiire7UseList")
@interface UseList : RealmSwiftObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Oshiire14ViewController")
@interface ViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified test;
